...
namespace PotatoVN.Client.Model
{
    ...
    /// UserLoginDto
    /// </summary>
    [DataContract(Name = "UserLoginDto")]
    public partial class UserLoginDto : IValidatableObject
    {
        /// <summary>
        ...
        public UserLoginDto(string userName = default, string password = default)
        {
            // to ensure "userName" is required (not null)
            if (userName == null)
            {
                throw new ArgumentNullException("userName is a required property for UserLoginDto and cannot be null");
            }
            this.UserName = userName;
            // to ensure "password" is required (not null)
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for UserLoginDto and cannot be null");
            }
