...
namespace PotatoVN.Client.Model
{
    ...
    public partial class StaffDto : IValidatableObject
    {
        ...
        public StaffDto(int id = default, bool isDeleted = default, string bgmId = default, string vndbId = default, string ymgalId = default, string japaneseName = default, string englishName = default, string chineseName = default, Gender? gender = default, string description = default, long birthDateTimestamp = default, string externalImageLink = default, string imageUrl = default, long lastModifyTimestamp = default, List<StaffGameDto> staffGames = default)
        {
            this.Id = id;
