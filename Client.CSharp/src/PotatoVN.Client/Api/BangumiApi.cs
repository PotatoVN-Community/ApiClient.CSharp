...
namespace PotatoVN.Client.Api
{
    ...
    public interface IBangumiApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<BangumiToken> BangumiOauthGetAsync(string code, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<BangumiToken>> BangumiOauthGetWithHttpInfoAsync(string code, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// 使用refresh token换取bgm token
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BangumiToken</returns>
        System.Threading.Tasks.Task<BangumiToken> BangumiRefreshGetAsync(string refreshToken, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BangumiToken)</returns>
        System.Threading.Tasks.Task<ApiResponse<BangumiToken>> BangumiRefreshGetWithHttpInfoAsync(string refreshToken, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class BangumiApi : IDisposable, IBangumiApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BangumiToken</returns>
        public async System.Threading.Tasks.Task<BangumiToken> BangumiOauthGetAsync(string code, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BangumiToken)</returns>
        public async System.Threading.Tasks.Task<PotatoVN.Client.Client.ApiResponse<BangumiToken>> BangumiOauthGetWithHttpInfoAsync(string code, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'code' is set
            if (code == null)
                throw new PotatoVN.Client.Client.ApiException(400, "Missing required parameter 'code' when calling BangumiApi->BangumiOauthGet");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BangumiToken</returns>
        public async System.Threading.Tasks.Task<BangumiToken> BangumiRefreshGetAsync(string refreshToken, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BangumiToken)</returns>
        public async System.Threading.Tasks.Task<PotatoVN.Client.Client.ApiResponse<BangumiToken>> BangumiRefreshGetWithHttpInfoAsync(string refreshToken, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'refreshToken' is set
            if (refreshToken == null)
                throw new PotatoVN.Client.Client.ApiException(400, "Missing required parameter 'refreshToken' when calling BangumiApi->BangumiRefreshGet");
