...
namespace PotatoVN.Client.Model
{
    ...
    public partial class UserModifyDto : IValidatableObject
    {
        ...
        public UserModifyDto(string userDisplayName = default(string), string avatarLoc = default(string), string oldPassword = default(string), string newPassword = default(string))
        {
