...
namespace PotatoVN.Client.Model
{
    ...
    public partial class UserDto : IValidatableObject
    {
        ...
        public UserDto(int id = default(int), string userName = default(string), string userDisplayName = default(string), UserType? type = default(UserType?), int bangumiId = default(int), string avatar = default(string), long usedSpace = default(long), long totalSpace = default(long), long lastGalChangedTimeStamp = default(long))
        {
            this.Id = id;
