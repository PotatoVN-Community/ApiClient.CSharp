...
namespace PotatoVN.Client.Model
{
    ...
    public partial class CharacterDto : IValidatableObject
    {
        ...
        public CharacterDto(int id = default(int), string name = default(string), string relation = default(string), string summary = default(string), Gender? gender = default(Gender?), int birthYear = default(int), int birthMonth = default(int), int birthDay = default(int), string bloodType = default(string), string height = default(string), string weight = default(string), string threeSize = default(string), string imageUrl = default(string), string previewImageUrl = default(string))
        {
            this.Id = id;
            this.Name = name;
