...
namespace PotatoVN.Client.Model
{
    ...
    public partial class GalgameUpdateDto : IValidatableObject
    {
        ...
        /// <param name="headerImageExternalUrl">headerImageExternalUrl.</param>
        /// <param name="headerImageOssLoc">headerImageOssLoc.</param>
        ...
        public GalgameUpdateDto(int? id = default, string bgmId = default, string vndbId = default, string name = default, string cnName = default, string description = default, string developer = default, string expectedPlayTime = default, float? rating = default, long? releaseDateTimeStamp = default, string imageLoc = default, string headerImageExternalUrl = default, string headerImageOssLoc = default, List<string> tags = default, int? totalPlayTime = default, PlayType? playType = default, List<CharacterUpdateDto> characters = default, List<PlayLogDto> playTime = default, string comment = default, int? myRate = default, bool? privateComment = default, int? playCount = default)
        {
            ...
            this.HeaderImageExternalUrl = headerImageExternalUrl;
            this.HeaderImageOssLoc = headerImageOssLoc;
            this.Tags = tags;
        ...
        /// <summary>
        /// Gets or Sets HeaderImageExternalUrl
        /// </summary>
        [DataMember(Name = "headerImageExternalUrl", EmitDefaultValue = true)]
        public string HeaderImageExternalUrl { get; set; }

        /// <summary>
        /// Gets or Sets HeaderImageOssLoc
        /// </summary>
        [DataMember(Name = "headerImageOssLoc", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HeaderImageExternalUrl: ").Append(HeaderImageExternalUrl).Append("\n");
            sb.Append("  HeaderImageOssLoc: ").Append(HeaderImageOssLoc).Append("\n");
