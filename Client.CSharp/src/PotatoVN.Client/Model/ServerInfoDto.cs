...
namespace PotatoVN.Client.Model
{
    ...
    public partial class ServerInfoDto : IValidatableObject
    {
        ...
        public ServerInfoDto(bool bangumiOAuth2Enable = default, bool defaultLoginEnable = default, bool bangumiLoginEnable = default, bool galgameStaffAvailable = default, bool staffEnable = default)
        {
